...
%		};
%		% Input arrows
%		\draw[<-,align=center] (mat-2-1) -- node[above] {4 Major \\ Pitches} +(-2cm,0);
%		\draw[<-,align=center] (mat-4-1) -- node[above] {3 Minor \\ Pitches} +(-2cm,0);
%		\draw[<-,align=center] (mat-6-1) -- node[above] {2 Octaves} +(-2cm,0);
%		\draw[<-,align=center] (mat-8-1) -- node[above] {2 Octaves} +(-2cm,0);
...
%		% Hidden -> Hidden
%		\foreach \ai in {3,6,9}
%			\draw[->,line width=0.3mm] (mat-\ai-2) edge[loop right] (mat-\ai-3);
%		% Hidden -> Output
%		\foreach \ai in {3,6,9}
%		{\foreach \aii in {2,4,6,8,10}
%			\draw[->] (mat-\ai-2) -- (mat-\aii-3);
